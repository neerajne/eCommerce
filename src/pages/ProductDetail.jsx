            ...
            <div className="flex flex-wrap justify-around">
              ...
              <div className="max-w-xl my-3">
                ...
                {product.best_seller && (<span className="font-semibold text-amber-500 border bg-amber-50 rounded-lg px-3 py-1 mr-2 btn btn-outline-success ">BEST SELLER</span>)}     
                 { product.in_stock ? (<span className="font-semibold text-emerald-600	border bg-slate-100 rounded-lg px-3 py-1 mr-2 btn btn-outline-warning ">INSTOCK</span>) : (<span className="font-semibold text-emerald-600	border bg-slate-100 rounded-lg px-3 py-1 mr-2 btn btn-outline-danger">OUT OF STOCK</span>)   }
